    ...
    <div className="min-h-screen bg-background pb-16 md:pb-0">
      ...
      <header className="bg-card border-b border-border px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <img src={logo} alt="MurciélagoLingo Logo" className="w-10 h-10 object-contain drop-shadow-[0_0_8px_rgba(255,181,167,0.6)]" />
          <span className="font-heading font-bold text-foreground text-lg tracking-tight">MurciélagoLingo</span>
        </div>
        <div className="flex items-center gap-3">
          <button
