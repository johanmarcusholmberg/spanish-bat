...
const translations: Translations = {
  ...
  // Pronunciation page (Echo)
  pronTitle: { sv: "Uttalsövning", en: "Pronunciation Practice" },
  pronTagline: { sv: "Låt oss finjustera ditt uttal", en: "Let's tune your pronunciation" },
  pronListen: { sv: "Lyssna", en: "Listen" },
  pronListenAgain: { sv: "Lyssna igen", en: "Listen again" },
  pronEcho: { sv: "Eka tillbaka", en: "Echo it back" },
  pronRecording: { sv: "Spelar in din eko…", en: "Recording your echo…" },
  pronListening: { sv: "Lyssnar…", en: "Listening…" },
  pronAnalyzing: { sv: "Analyserar…", en: "Analyzing…" },
  pronStop: { sv: "Stoppa inspelning", en: "Stop recording" },
  pronStart: { sv: "Starta inspelning", en: "Start recording" },
  pronRetry: { sv: "Försök igen", en: "Try one more echo" },
  pronContinue: { sv: "Nästa", en: "Next" },
  pronSeeResults: { sv: "Se resultat", en: "See results" },
  pronSkip: { sv: "Hoppa över", en: "Skip" },
  pronWordLabel: { sv: "Ord", en: "Word" },
  pronPhraseLabel: { sv: "Fras", en: "Phrase" },
  pronSentenceLabel: { sv: "Mening", en: "Sentence" },
  pronModeWords: { sv: "Ord", en: "Words" },
  pronModePhrases: { sv: "Fraser", en: "Phrases" },
  pronModeSentences: { sv: "Meningar", en: "Sentences" },
  pronModeRepeat: { sv: "Upprepa", en: "Repeat" },
  pronModeRandom: { sv: "Slumpmässig", en: "Random" },
  pronYouSaid: { sv: "Du sa", en: "You said" },
  pronWordByWord: { sv: "Ord-för-ord analys", en: "Word-by-word analysis" },
  pronTipsLabel: { sv: "Tips", en: "Tips" },
  pronFocusSound: { sv: "Fokusera ljudet", en: "Focus sound" },
  pronRhythmTip: { sv: "Rytm-tips", en: "Rhythm tip" },
  pronStressTip: { sv: "Betoningstips", en: "Stress tip" },
  pronGreatEcho: { sv: "Bra eko!", en: "Great echo!" },
  pronTryAnother: { sv: "Prova ett eko till", en: "Try one more echo" },
  pronPracticeWord: { sv: "Öva", en: "Practice" },
  pronSessionComplete: { sv: "Session klar!", en: "Session complete!" },
  pronSessionSummary: { sv: "Du klarade {correct} av {total} (snittpoäng {avg}%)", en: "You got {correct} of {total} correct (avg score {avg}%)" },
  pronTryAgainSession: { sv: "Gör om", en: "Try again" },
  pronNewMode: { sv: "Nytt läge", en: "New mode" },
  pronAttempts: { sv: "Försök", en: "Attempts" },
  pronCorrect: { sv: "Rätt", en: "Correct" },
  pronAccuracy: { sv: "Precision", en: "Accuracy" },
  pronAvg: { sv: "snitt", en: "avg" },
  pronSaveToDict: { sv: "Spara till ordbok", en: "Save to dictionary" },

  // Microphone permission states
  micCheckingPermission: { sv: "Kontrollerar mikrofonbehörighet…", en: "Checking microphone permission…" },
  micNeedAccess: { sv: "Murciélingo behöver tillgång till din mikrofon för att höra ditt eko.", en: "Murciélingo needs access to your microphone to hear your echo." },
  micGrantAccess: { sv: "Tillåt mikrofon", en: "Allow microphone" },
  micDenied: { sv: "Mikrofonen är blockerad. Tillåt mikrofon i webbläsarens inställningar för att öva uttal.", en: "Microphone is blocked. Allow microphone in your browser settings to practice pronunciation." },
  micUnavailable: { sv: "Vi hittar ingen mikrofon. Anslut en mikrofon och försök igen.", en: "We can't find a microphone. Connect one and try again." },
  micUnsupported: { sv: "Din webbläsare stöder inte röstinmatning. Prova Chrome eller Edge.", en: "Your browser does not support speech recognition. Try Chrome or Edge." },
  micRetryButton: { sv: "Försök igen", en: "Try again" },
  micMaxReached: { sv: "Max inspelningstid nådd – analyserar…", en: "Max recording time reached — analyzing…" },

  // Honest disclosure about assessment
  pronAssessmentNote: { sv: "Bedömningen jämför vad du sa med målfrasen. Riktig akustisk uttalspoäng kommer snart.", en: "Scoring compares what you said with the target phrase. Real acoustic pronunciation scoring is coming soon." },
