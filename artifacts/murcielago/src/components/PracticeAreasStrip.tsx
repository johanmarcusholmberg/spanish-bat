...
const AREAS: Area[] = [
  {
    ...
    Motif: MicPulseMotif,
    title: { en: "Improve pronunciation", sv: "Förbättra uttalet" },
    desc: {
      en: "Practice difficult sounds and speak more clearly.",
      sv: "Öva svåra ljud och tala tydligare.",
    },
  ...
  },
  {
    ...
    title: { en: "Review saved words", sv: "Repetera sparade ord" },
    desc: {
      en: "Strengthen recall on words you've practiced before.",
      sv: "Stärk minnet av ord du redan övat på.",
    },
  ...
  },
  {
    ...
    status: { en: "Pick up where you left off", sv: "Fortsätt där du slutade", tone: "continue" },
  },
  {
    key: "listening",
    href: "/learn/conversation",
    Motif: WaveformMotif,
    title: { en: "Train your ear", sv: "Träna örat" },
    desc: {
      en: "Hear short Spanish clips and build recognition.",
      sv: "Lyssna på korta spanska klipp och känn igen mer.",
    },
    status: { en: "Short listening session", sv: "Kort lyssnarsession", tone: "neutral" },
  },
];
